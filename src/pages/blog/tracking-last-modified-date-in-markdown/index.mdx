...
export const components = {pre: (props) => <Code client:load {...props} />}
...
Honestly: I am tracking it manually (when I'm done writing, I'd update the frontmatter). One of the reasons is that I've migrated my older blog posts to MDX, thus neither the file creation dates nor the commit dates do match the genuine birth dates.
