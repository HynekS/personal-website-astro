...
<Note>This article is a little outdated. It was written at the time of a transition to the new Sanity UI kit (which explains why some of the code is a little 'hairy' here). While the fundamentals of this tutorial are still valid, I would suggest to check the <a style={{ all: "unset", textDecoration: "underline", cursor: "pointer" }} href="https://www.sanity.io/docs/custom-input-widgets">new docs</a> at first.</Note>
