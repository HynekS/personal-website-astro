...
The most serious issue was the speed of the development server. To put it bluntly, it was just unbearable. Every simple change in a results in a delay that usually takes as much as 30 seconds. I honestly don't know what was causing that (probably a markdown compilation related issue), but it was just awful.
